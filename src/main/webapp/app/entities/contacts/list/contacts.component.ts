...
export class ContactsComponent implements OnInit {
  ...
  constructor(protected contactsService: ContactsService, protected modalService: NgbModal, protected parseLinks: ParseLinks) {
    this.contacts = [];
  ...
  loadAll(): void {
    ...
    this.contactsService
      ...
      .subscribe({
        next: (res: HttpResponse<IContacts[]>) => {
  ...
  trackId(index: number, item: IContacts): string {
    return item.id!;
  }
  ...
  protected paginateContacts(data: IContacts[] | null, headers: HttpHeaders): void {
